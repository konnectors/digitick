...
```
$ git clone github.com/konnectors/digitick.git
$ cd digitick
$ git remote add fork git://github.com/yourusername/digitick.git
```
...
Go to https://github.com/yourusername/digitick and select your branch. Click the 'Pull Request' button and fill out the form.
...
[issues]: https://github.com/konnectors/digitick/issues/new
...
[localization]: https://github.com/konnectors/digitick/blob/master/README.md#localization
